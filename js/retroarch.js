    ...
    return (
      function (EmulatorJS) {
        ...
        function _RWebAudioInit(latency) {
          ...
          document.querySelector(".gba-msg").innerHTML = '<input type="button" value="启动模拟器音乐" data-btn="startMusic">';
          document.querySelector(".gba-msg").style.display = "";
          Module.startMusic = () => {
            if (RA.context) {
              RA.context.resume();
